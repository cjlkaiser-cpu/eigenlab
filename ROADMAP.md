...
**Total: 204 simulaciones · 160/170 con guía (94%) · 0 enlaces internos rotos** (`python3 tools/check_links.py`)
...
- ✅ **Curso «La Tabla Periódica, de dentro afuera»** (Chemistry, `curso-tabla-periodica/`): módulos 1–5, 23 lecciones con predicción, simulación embebida, autoevaluación y progreso; módulo 6 pendiente (origen cósmico, relativistas, superpesados)
