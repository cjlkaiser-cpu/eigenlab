...
├── Chemistry/
│   └── Chemistry Visual Lab/   # 26 sims + curso de la tabla periódica
├── Biochemistry/
...
| **Chemistry** | Visual (26) + curso | 26 | Cyan | ✅ Maduro |
...
**Total:** 206 simulaciones · 162/172 con guía (94%). Fuente de verdad: `python3 tools/stats.py`
...
- **206 simulaciones** totales · **162/172 con guía** (94%)
